<?php
namespace fetova\Administrator\DataTable\Columns;

use fetova\Administrator\Validator;
use fetova\Administrator\Config\ConfigInterface;
use Illuminate\Database\DatabaseManager as DB;

use fetova\Administrator\DataTable\Columns\Relationships\BelongsTo;
use fetova\Administrator\DataTable\Columns\Relationships\BelongsToMany;
use fetova\Administrator\DataTable\Columns\Relationships\HasOneOrMany;
...
class Factory {
	 ...
	 * @param array		$options
	 *
	 * @return \fetova\Administrator\DataTable\Columns\Column
	 */
	...
	public function getIncludedColumns(array $fields)
	{
		...
		if (!sizeof($this->includedColumns))
		{
			...
			{
				if (is_a($field, 'fetova\\Administrator\\Fields\\Relationships\\BelongsTo'))
				{
