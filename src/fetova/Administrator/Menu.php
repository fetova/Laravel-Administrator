<?php
namespace fetova\Administrator;
...
class Menu {
	 ...
	 * The config instance
	 *
	 * @var \fetova\Administrator\Config\Factory
	 */
	 ...
	 * @param \fetova\Administrator\Config\Factory	$config
	 */
	...
	public function getMenu($subMenu = null)
	{
		...
		foreach ($subMenu as $key => $item)
		{
			...
			if (is_string($item))
			{
				...
				if (is_a($config, 'fetova\Administrator\Config\Config') && $config->getOption('permission'))
				{
