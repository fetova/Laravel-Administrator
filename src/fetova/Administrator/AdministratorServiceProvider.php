<?php namespace fetova\Administrator;

use fetova\Administrator\Config\Factory as ConfigFactory;
...
use fetova\Administrator\DataTable\DataTable;
...
class AdministratorServiceProvider extends ServiceProvider {
	...
	{
		$this->package('fetova/administrator');
