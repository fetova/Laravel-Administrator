<?php
namespace fetova\Administrator\Config\Model;

use fetova\Administrator\Config\Config as ConfigBase;
use fetova\Administrator\Config\ConfigInterface;
use fetova\Administrator\Fields\Factory as FieldFactory;
use fetova\Administrator\Fields\Field as Field;
use fetova\Administrator\Actions\Factory as ActionFactory;
...
class Config extends ConfigBase implements ConfigInterface {
	 ...
	 * @param \fetova\Administrator\Actions\Factory	$actionFactory
	 *
	 * @return \Illuminate\Database\Eloquent\Model
	 */
