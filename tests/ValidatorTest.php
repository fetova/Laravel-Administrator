...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->validator = m::mock('fetova\Administrator\Validator')->makePartial();
	}
	...
	{
		$this->assertTrue($this->validator->validateEloquent(null, 'fetova\Administrator\Tests\EloquentStub', null));
	}
