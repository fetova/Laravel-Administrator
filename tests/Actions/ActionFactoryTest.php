...
class ActionFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->factory = m::mock('fetova\Administrator\Actions\Factory', array($this->validator, $this->config))->makePartial();
	}
	...
	{
		$action = m::mock('fetova\Administrator\Actions\Action');
