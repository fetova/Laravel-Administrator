<?php
namespace fetova\Administrator\Tests\Fields;
...
class FieldFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->factory = m::mock('fetova\Administrator\Fields\Factory', array($this->validator, $this->config, $this->db))->makePartial();
	}
	...
	{
		$this->factory->shouldReceive('getFieldTypeClass')->once()->andReturn('fetova\Administrator\Tests\Fields\FieldStub');
	...
	public function testApplyConstraints()
	{
		...
		$otherField = m::mock('fetova\Administrator\Fields\Field');
