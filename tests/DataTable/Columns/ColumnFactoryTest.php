<?php
namespace fetova\Administrator\Tests\DataTable\Columns;
...
class ColumnFactoryTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @var string
	 */
	protected $namespace = 'fetova\\Administrator\\DataTable\\Columns\\';
	...
	public function setUp()
	{
		...
		$this->factory = m::mock('fetova\Administrator\DataTable\Columns\Factory', array($this->validator, $this->config, $this->db))->makePartial();
	}
	...
	{
		$stub = new ColumnStub;
		$this->factory->shouldReceive('getColumnClassName')->once()->andReturn('fetova\Administrator\Tests\DataTable\Columns\ColumnStub');
	...
	public function testGetIncludedColumnsReturnsColumns()
	{
		...
		$columnRelated = m::mock('fetova\Administrator\DataTable\Columns\Column');
		...
		$columnNormal = m::mock('fetova\Administrator\DataTable\Columns\Column');
		$columnNormal->shouldReceive('getOption')->times(4)->andReturn(false, false, 'normal', 'normal');
		$columnComputed = m::mock('fetova\Administrator\DataTable\Columns\Column');
	...
	public function testGetIncludedColumnsAddsBelongsToField()
	{
		...
		$field = m::mock('fetova\\Administrator\\Fields\\Relationships\\BelongsTo');
