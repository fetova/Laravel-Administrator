...
class DataTableTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->columnFactory = m::mock('fetova\Administrator\DataTable\Columns\Factory');
		$this->fieldFactory = m::mock('fetova\Administrator\Fields\Factory');
		$this->dataTable = m::mock('fetova\Administrator\DataTable\DataTable', array($this->config, $this->columnFactory, $this->fieldFactory))
								->makePartial();
	}
	...
	{
		$column = m::mock('fetova\Administrator\DataTable\Columns\Column');
	...
	{
		$column1 = m::mock('fetova\Administrator\DataTable\Columns\Column');
		$column1->shouldReceive('renderOutput')->once()->andReturn('rendered');
		$column2 = m::mock('fetova\Administrator\DataTable\Columns\Column');
