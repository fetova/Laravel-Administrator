<?php
namespace fetova\Administrator\Tests;
...
class MenuTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->configFactory = m::mock('fetova\Administrator\Config\Factory');
		$this->menu = m::mock('fetova\Administrator\Menu', array($this->config, $this->configFactory))->makePartial();
	}
	...
	public function testGetMenuSimpleReturnWithPermission()
	{
		...
		$itemconfig = m::mock('fetova\Administrator\Config\Config');
